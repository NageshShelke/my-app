  ...
  return (
    <div>
      <div className="mt-24 w-full">
        <h2
          id="projects"
          className="font-bold text-lg tracking-widest text-white uppercase mb-5"
        >
          Get In Touch
        </h2>
      </div>
      ...
      <div id="contact" className="gap-20 flex items-center pt-6 border-t border-light-gray/20 mb-16">
        ...
        <div className="flex items-center gap-2 text-light-gray hover:text-white">
          ...
          <a href="mailto:nageshpatil6129@gmail.com">nageshpatil6129@gmail.com</a>
        </div>

        <div className="flex items-center gap-2 text-light-gray hover:text-white">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" stroke="none" className="tabler-icon tabler-icon-phone-filled">
